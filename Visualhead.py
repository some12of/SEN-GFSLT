...
from utils1 import PositionalEncoding, MaskedNorm, PositionwiseFeedForward, MLPHead
...
class VisualHead(torch.nn.Module):
    def __init__(
            ...
            ff_kernelsize=3, pretrained_ckpt="/home/zfc2b/CV-SLT-main/experiments/configs/SingleStream/phoenix-2014t_s2g/ckpts/best.ckpt", is_empty=False, freeze=False,
            plus_conv_cfg={}, ssl_projection_cfg={}
    ):
        super().__init__()
    ...
    def load_from_pretrained_ckpt(self, pretrained_ckpt):
        ...
        print('Load Visual Head from pretrained ckpt {}'.format(pretrained_ckpt))
