...
val_texts_freq=get_freq(val_texts)
sorted_word_freq11 = dict(sorted(val_texts_freq.items(), key=lambda item: item[1]))
print(sorted_word_freq11)   
# 获取测试集的词频字典  
